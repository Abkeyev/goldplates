      ...
      <div className={classes.container}>
        ...
        >
          <BccTypography type="h4" className={classes.topText}>
            Клиенты, которые <span>впервые</span> получают пособие
          </BccTypography>
          ...
          <Grid item container wrap="nowrap" justify="space-between">
            ...
            <Grid item>
              ...
              <BccTypography type="p2l" block>
                Получайте пособие не выходя из дома
              </BccTypography>
            </Grid>
          </Grid>
        </Grid>
        ...
        >
          <BccTypography type="h4" className={classes.topText}>
            Клиенты, которые <span>уже получают</span> пособие
          </BccTypography>
          <Grid item container wrap="nowrap" justify="space-between">
            <Grid item>
              <img src={process.env.PUBLIC_URL + "/img/t1.svg"} />
